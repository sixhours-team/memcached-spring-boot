...
E.g. to specify an `expiration` of 30 seconds, `30`, `PT30S` (ISO-8601 format) and `30s` are all equivalent. An `operatio-timeout` of 500ms can be specified in any of the following form: `500`, `PT0.5S` (ISO-8601 format) and `500ms`.
